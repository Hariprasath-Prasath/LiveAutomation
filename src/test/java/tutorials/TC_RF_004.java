...
public class TC_RF_004 {
	...
	public void verifyRegistringAccountWithoutFillField(){
		...
		Assert.assertEquals(driver.findElement(By.xpath("//input[@id='input-telephone']/following-sibling::div")).getText(), expectedTelephoneNumber);
		...
		Assert.assertEquals(driver.findElement(By.xpath("//div[contains(text(),'Warning')]")).getText(), expectedWarning);
